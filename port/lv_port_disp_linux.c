...
static void software_fill(const lv_area_t * area, lv_color_t * color_p)
{
    // int32_t x;
    // int32_t y;
    ...
    memcpy(fbdev_info.fb_base, &color_p->full, (MY_DISP_HOR_RES * MY_DISP_VER_RES)*sizeof(lv_color_t));
}

static void dma_fill(const lv_area_t * area, lv_color_t * color_p)
{
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    ...
    #if LV_DISP_FILL_METHOD == 0
    software_fill(area, color_p);
    #elif LV_DISP_FILL_METHOD == 1
    dma_fill(area, color_p);
    #else
    software_fill(area, color_p);
    #endif
